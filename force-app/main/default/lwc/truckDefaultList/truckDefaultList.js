...
import fetchTruck from '@salesforce/apex/DriverAssignmentController.TruckLookUp';
import{CurrentPageReference} from 'lightning/navigation';
import { registerListener, unregisterAllListeners, fireEvent } from 'c/pubsub';
export default class TruckDefaulList extends LightningElement {
...
@wire(fetchTruck, {transportJobID:'$getIdFromParent'})
picklistvalues({data,error}){
        ...
        if((this.getTruckId !== undefined) && (this.getTruckId !== null)){

            this.selectedAccount = this.getTruckName;

            //Currently this is used by Truck field
            var eventParam = {'selectedvalueid': this.getTruckId};
            fireEvent(this.pageRef, 'truckvalue',eventParam);
