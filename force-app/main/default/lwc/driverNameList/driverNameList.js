...
import fetchDriverName from '@salesforce/apex/DriverAssignmentController.DriverNameLookUp';
import{CurrentPageReference} from 'lightning/navigation';
import { registerListener, unregisterAllListeners, fireEvent } from 'c/pubsub';
export default class DriverNameList extends LightningElement {
...
picklistvalues({data,error}){
        ...
        if((this.getDriverId !== undefined) && (this.getDriverId !== null)){

            alert("edit");
            this.selectedAccount = this.getDriverName;

            //Currently this is used by Configuration field
            var eventParam = {'selectedvalueid': this.getDriverId};
            fireEvent(this.pageRef, 'drivernamevalue',eventParam);
