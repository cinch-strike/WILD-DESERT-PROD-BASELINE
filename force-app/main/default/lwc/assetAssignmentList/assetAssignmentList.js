...
import fetchAsset from '@salesforce/apex/AssetAssignmentController.AssetLookUp';
import{CurrentPageReference} from 'lightning/navigation';
import { registerListener, unregisterAllListeners, fireEvent } from 'c/pubsub';
export default class AssetAssignmentList extends LightningElement {

//Identifying Transport Job ID
@wire (CurrentPageReference) pageRef;
connectedCallback() {
    registerListener('removeselectedasset' ,this.handleRemoveSelectedOption, this);
}
...
@wire(fetchAsset, {unitID:'$getIdFromParent'})
picklistvalues({data,error}){
        ...
        key:key.Id,
        value:key.Name_and_Rego_Number__c
        });
        });
...
handleOptionSelect(event) {
    ...
    fireEvent(this.pageRef, 'assetvalue',eventParam);
