({
    doInit : function(component,event,helper){
        ...
        //17 Jan 2023 C+S: Added the filter as parameter of the recent records
    ...
    createNewRecord : function(component, event, helper) {
        var createRecordEvent = $A.get("e.force:createRecord"),
            objectName = component.get("v.objectAPIName"),
            returnFields = component.get("v.returnFields"),
            filter = component.get("v.filter"); //17 Jan 2023 C+S: Added the filter as parameter of the recent records
